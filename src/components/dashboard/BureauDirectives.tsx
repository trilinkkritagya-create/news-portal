  ...
  return (
    <div className="bg-card border border-border rounded-xl p-4 sm:p-5 shadow-2xs">
      ...
      <div className="space-y-2.5">
        ...
        <div className="p-2.5 bg-slate-50 dark:bg-slate-900 border-l-2 border-red-600 rounded-r text-xs">
          ...
          <p className="font-medium text-foreground leading-snug text-xs">
        ...
        {/* Directive 2: Style Guide (Primary Blue) */}
        <div className="p-2.5 bg-slate-50 dark:bg-slate-900 border-l-2 border-primary rounded-r text-xs">
          <div className="flex items-center justify-between mb-0.5">
            <span className="font-mono font-semibold text-primary dark:text-blue-400 text-[10px] uppercase tracking-wider">
              Style Guide
            </span>
            <span className="font-mono text-[10px] text-muted-foreground">
              v3.2
        ...
        <div className="p-2.5 bg-slate-50 dark:bg-slate-900 border-l-2 border-emerald-600 rounded-r text-xs">
          <div className="flex items-center justify-between mb-0.5">
      ...
      <button
        type="button"
        className="w-full mt-3 py-1.5 border border-border hover:bg-muted text-xs font-medium text-foreground rounded-lg transition-colors flex items-center justify-center gap-1.5 cursor-pointer shadow-2xs"
      >
