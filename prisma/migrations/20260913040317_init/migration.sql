-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('MEMBER', 'AUTHOR', 'ADMIN');
...
-- CreateIndex
CREATE INDEX "ArticleShare_articleId_createdAt_idx" ON "ArticleShare"("articleId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "ArticleShare" ADD CONSTRAINT "ArticleShare_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
